...
import 'package:express_delivery/models/message_model.dart';
...
class _AppState extends State<App> {
  late Timer messageRefreshTimer;
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ListenableProvider(create: ((context) => MessageModel()))
      ],
      child: Builder(
        builder: (context) {
          messageRefreshTimer = Timer(const Duration(seconds: 5), () {
            context.read<MessageModel>().refresh();
          });
          return MaterialApp(
            title: '快递代拿',
            theme: ThemeData(
